...
var createNewTaskElement = function (taskString) {
  ...
  listItem.className = 'tasks__item tasks__item_incomplete';

  label.innerText = taskString;
  label.className = 'label task middle';

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = "input input_check middle";
  editInput.type = "text";
  editInput.className = "input input_text hide middle";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "btn btn_edit middle";
...
var editTask = function () {
  ...
  var containsClass = editInput.classList.contains("input_editmode");
  ...
  editInput.classList.toggle("input_editmode");
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  listItem.querySelector('.label').classList.toggle('complete-task');
